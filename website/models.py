...
class Thermostat(db.Model):
    ...
    wifi = db.Column(db.Boolean, default=True)  # rue - есть wifi подключение, False - подключения нет
    ...
    mock_mode = db.Column(db.Boolean, default=True) #True - режим имитации вкл., False - выкл.
